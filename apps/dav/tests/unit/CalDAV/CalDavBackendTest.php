...
EOD;
		...
		$this->assertStringContainsString('DTSTART:20131027T120000Z', $mySearchResults[0]['calendardata']);

		$this->assertStringContainsString('SUMMARY:My Test (private)', $mySearchResults[1]['calendardata']);
		$this->assertStringContainsString('DTSTART:20131027T120000Z', $mySearchResults[1]['calendardata']);

		$this->assertStringContainsString('SUMMARY:My Test (confidential)', $mySearchResults[2]['calendardata']);
		$this->assertStringContainsString('DTSTART:20131027T120000Z', $mySearchResults[2]['calendardata']);

		$this->assertStringContainsString('SUMMARY:Sharer Test (public)', $mySearchResults[3]['calendardata']);
		$this->assertStringContainsString('DTSTART:20131027T120000Z', $mySearchResults[3]['calendardata']);

		// Results without a time range are not expanded: the RRULE is preserved.
